...
export default function Page() {
    return (
        <div>
            ...
            <Image src={"/background_projects.jpg"} alt={""} width={3500} height={2480}
                   className="absolute top-0 -z-10 w-screen h-screen overflow-hidden"/>
            <div className={"w-full py-4 px-4 md:py-8 md:px-16"}>
                <Navigation/>
                <h1 className={"mb-4"}>My Competencies</h1>
                <div className={"grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8"}>
                    <ProjectCard name={"AniStack"} icon={"/icon_website-icon.png"}
                    ...
                    <ProjectCard name={"GitHub Release Notifyer (Planned Project)"} icon={"/icon_website-icon.png"}
                                 description={"A GitHub Notification Service to track GitHub Releases and Sendout Notifications"}/>
