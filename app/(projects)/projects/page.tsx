    ...
    <div className="">
      ...
      <div id="project_container" className="grid grid-cols-2">
        ...
        <ProjectCard projectTitle="Marketplace">
          ...
          <ProjectDetail label="Project Description" className="mb-6">
            <p>The marketplace platform is a cross between Amazon, Fiverr and Etsy. It is a buy and sell platform where anyone can register for a &lsquo;business account&lsquo; and sell items.</p>
          </ProjectDetail>
          <ProjectDetail label="GitHub Repositorys:" className="mb-6">
