...
export const ProjectCard = ({ children, projectTitle, className, scale }: ProjectCardProps) => {
    return (
        <div id="main_card" className={`h-fit w-5/6 mt-8 mx-12 z-10 ${scale == true ? "hover:scale-105 duration-300 cursor-pointer" : ""} hover:shadow-[0_35px_60px_-15px_rgba(112,26,117,0.3)] ${className}`}>
